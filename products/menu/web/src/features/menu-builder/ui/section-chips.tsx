...
export function SectionChips({
  ...
  return (
    <nav
      ...
      className="sticky top-0 z-30 -mx-4 -mt-2 bg-background/90 px-4 py-2.5 backdrop-blur-md"
    >
      <div
        ref={scrollerRef}
        className="flex gap-2 overflow-x-auto scroll-smooth pb-0.5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
      >
        {categories.map((c) => {
          ...
          return (
            <button
              ...
              className="flex min-h-9 flex-[0_0_auto] cursor-pointer items-center whitespace-nowrap rounded-full border border-border bg-card px-4 py-[7px] text-sm font-medium text-muted-foreground transition-colors hover:border-primary hover:text-foreground data-[active=true]:border-primary data-[active=true]:bg-primary data-[active=true]:text-primary-foreground"
            >
              {c.name}
            </button>
          )
        ...
        <button
          ...
          className="flex min-h-9 flex-[0_0_auto] cursor-pointer items-center whitespace-nowrap rounded-full border border-dashed border-primary/45 bg-card px-4 py-[7px] text-sm font-semibold text-primary transition-colors hover:border-primary"
        >
          {addLabel}
        </button>
      </div>
